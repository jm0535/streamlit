...
export function AudioProcessor({ title, description, icon }: AudioProcessorProps) {
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => setSettings(prev => ({ ...prev, autoGain: !prev.autoGain }))}
                >
  ...
  const visualize = useCallback(() => {
    ...
    if (type === 'waveform') {
      ...
      for (let x = 0; x < width; x++) {
        const amplitude = Math.sin(x * 0.05 + Date.now() * 0.002) * 
