...
export default function PianoPage() {
  ...
  const [selectedResult, setSelectedResult] =
    useState<PianoAnalysisResult | null>(null);
    ...
    try {
      ...
      for (const file of uploadedFiles) {
        ...
        const mockResult: PianoAnalysisResult = {
          ...
          notes: allNotes,
          keySignature: ["C Major", "G Major", "D Major", "F Major", "A Minor"][
          ...
          technique: {
            ...
            articulation: ["Legato", "Staccato", "Slur"].slice(
              0,
              Math.floor(Math.random() * 3) + 1
            ),
            ornamentation: ["Trill", "Mordent", "Turn"].slice(
              0,
  ...
  const exportSheetMusic = useCallback(
    (result: PianoAnalysisResult) => {
      ...
      const blob = new Blob([JSON.stringify(sheetMusicData, null, 2)], {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Specialized analysis for piano recordings including hand separation,
            technique detection, and difficulty assessment
          </p>
        </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    {
                      key: "enableDifficultyAssessment",
                    ...
                    >
                      ...
                      <Switch
                        checked={
                          typeof pianoSettings[key as keyof PianoSettings] ===
                          "boolean"
                            ? (pianoSettings[
                                key as keyof PianoSettings
                              ] as boolean)
                            : false
                        }
                        onCheckedChange={(checked) =>
                          setPianoSettings((prev) => ({
                            ...prev,
                            [key]: checked,
                          }))
                        }
            ...
            <CardContent>
              {results.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">
                    Upload piano recordings and start analysis
                  </p>
                </div>
              ) : (
                <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1">
                          <Badge variant="outline" className="text-xs">
                            {getDifficultyLabel(
                              (result.difficulty.technicalDifficulty +
                                result.difficulty.rhythmicComplexity +
                                result.difficulty.harmonicComplexity) /
                                3
                            )}
                          </Badge>
                ...
                <Tabs value={currentTab} onValueChange={setCurrentTab}>
                      ...
                      <Card>
                        ...
                        <CardContent className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span>
                              {selectedResult.dynamics.averageVelocity.toFixed(
                                1
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            ...
                            <span>
                              {selectedResult.dynamics.velocityRange.toFixed(1)}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            ...
                            <span>
                              {getDynamicLabel(
                                selectedResult.dynamics.averageVelocity
                              )}
                            </span>
                          </div>
                        </CardContent>
                      ...
                      <Card>
                        ...
                        <CardContent className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span>
                              LH:{" "}
                              {selectedResult.handSeparation.leftHand.length} |
                              RH:{" "}
                              {selectedResult.handSeparation.rightHand.length}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span>Pedal Usage:</span>
                            <span>
                              {selectedResult.technique.pedalUsage
                                ? "Detected"
                                : "Not detected"}
                            </span>
                          </div>
                        ...
                        <CardContent className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span>
                              {selectedResult.handSeparation.leftHand.length > 0
                                ? (
                                    selectedResult.handSeparation.leftHand.reduce(
                                      (sum, note) => sum + note.midi,
                                      0
                                    ) /
                                    selectedResult.handSeparation.leftHand
                                      .length
                                  ).toFixed(1)
                                : "N/A"}
                            </span>
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span>
                              {selectedResult.handSeparation.leftHand.length > 0
                                ? `${Math.min(
                                    ...selectedResult.handSeparation.leftHand.map(
                                      (n) => n.midi
                                    )
                                  )}-${Math.max(
                                    ...selectedResult.handSeparation.leftHand.map(
                        ...
                        <CardContent className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span>
                              ...
                              0
                                ? (
                                    selectedResult.handSeparation.rightHand.reduce(
                                      (sum, note) => sum + note.midi,
                                      0
                                    ) /
                                    selectedResult.handSeparation.rightHand
                                      .length
                                  ).toFixed(1)
                                : "N/A"}
                            </span>
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span>
                              ...
                              0
                                ? `${Math.min(
                                    ...selectedResult.handSeparation.rightHand.map(
                                      (n) => n.midi
                                    )
                                  )}-${Math.max(
                                    ...selectedResult.handSeparation.rightHand.map(
                  ...
                  <TabsContent value="technique" className="space-y-4">
                        ...
                        <CardContent>
                          <div className="space-y-2">
                            <p className="text-sm font-medium">
                              Detected Articulation:
                            </p>
                            <div className="flex flex-wrap gap-1">
                              {selectedResult.technique.articulation.map(
                                (articulation, idx) => (
                                  <Badge
                                    key={idx}
                                    variant="secondary"
                          ...
                          {selectedResult.technique.ornamentation.length >
                            0 && (
                            <div className="space-y-2 mt-4">
                              ...
                              <div className="flex flex-wrap gap-1">
                                {selectedResult.technique.ornamentation.map(
                                  (ornament, idx) => (
                                    <Badge
                                      key={idx}
                                      variant="outline"
                        ...
                        <CardContent>
                          <div className="space-y-2">
                            <div className="flex justify-between text-sm">
                              ...
                              <span>
                                {selectedResult.technique.chords.length}
                              </span>
                            </div>
                            <div className="flex justify-between text-sm">
                              ...
                              <span>
                                {selectedResult.technique.chords.length > 0
                                  ? (
                                      selectedResult.technique.chords.reduce(
                                        (sum, chord) =>
                                          sum + chord.notes.length,
                                        0
                                      ) / selectedResult.technique.chords.length
                                    ).toFixed(1)
                                  : "N/A"}
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="space-y-2">
                          {selectedResult.dynamics.dynamicSegments.map(
                            (segment, idx) => (
                              <div
                                key={idx}
                        ...
                        <CardContent>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-blue-500">
                              {selectedResult.difficulty.technicalDifficulty.toFixed(
                                1
                              )}
                              /10
                            </div>
                            <Progress
                              value={
                                (selectedResult.difficulty.technicalDifficulty /
                                  10) *
                                100
                              }
                              className="w-full mt-2"
                        ...
                        <CardContent>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-green-500">
                              {selectedResult.difficulty.rhythmicComplexity.toFixed(
                                1
                              )}
                              /10
                            </div>
                            <Progress
                              value={
                                (selectedResult.difficulty.rhythmicComplexity /
                                  10) *
                                100
                              }
                              className="w-full mt-2"
                        ...
                        <CardContent>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-orange-500">
                              {selectedResult.difficulty.harmonicComplexity.toFixed(
                                1
                              )}
                              /10
                            </div>
                            <Progress
                              value={
                                (selectedResult.difficulty.harmonicComplexity /
                                  10) *
                                100
                              }
                              className="w-full mt-2"
