...
export default function FilesPage() {
  ...
  const [sortBy, setSortBy] = useState<"name" | "date" | "size" | "duration">(
    "date"
  );
          ...
          {selectedFiles.length > 0 && (
            <>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent>
                  <DropdownMenuItem
                    onClick={() => handleProcessFiles("transcription")}
                  >
                    Transcription
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onClick={() => handleProcessFiles("stem-separation")}
                  >
                    Stem Separation
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onClick={() => handleProcessFiles("analysis")}
                  >
                    Audio Analysis
                  </DropdownMenuItem>
                </DropdownMenuContent>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-xs text-muted-foreground space-y-1">
                          ...
                          <div>
                            {file.format} • {file.sampleRate}Hz •{" "}
                            {file.bitDepth}bit
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 text-xs">
                          ...
                          {file.transcription?.status === "processing" && (
                            <Progress
                              value={file.transcription.progress}
                        ...
                        <div className="flex items-center gap-2 text-xs">
                          {getStatusIcon(
                            file.stemSeparation?.status || "pending"
                          )}
                          <span>Stems</span>
                          {file.stemSeparation?.status === "processing" && (
                            <Progress
                              value={file.stemSeparation.progress}
                              className="flex-1 h-1"
                            />
                          )}
                        </div>
